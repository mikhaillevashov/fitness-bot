...
(GENDER, TARGET, AGE, WEIGHT, HEIGHT, FAVORITE_MEAT, FAVORITE_FRUIT, FAVORITE_CHEESE, FAVORITE_VEGETABLE,
 FAVORITE_SPICE, FAVORITE_GRAIN, SUGGEST_FOOD, POLL_RESPONSE, CHANGE_MENU, CHANGE_GENDER, CHANGE_TARGET,
 CHANGE_AGE, CHANGE_WEIGHT, CHANGE_HEIGHT) = range(19)

VALID_GENDERS = ['Мужской', 'Женский']
VALID_TARGETS = ['Дефицит калорий', 'Поддержание формы', 'Профицит калорий']
